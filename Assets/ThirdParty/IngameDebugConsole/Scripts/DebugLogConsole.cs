...
namespace IngameDebugConsole
{
	...
	public static class DebugLogConsole
	{
		...
		private static List<Func<string, bool>> m_commondActions = new List<Func<string, bool>>();
		public static void AddCommondRuleAction(Func<string, bool> func)
		{
			if (func == null) return;
			else
			{
				m_commondActions.Add(func);
			}
		}
		...
		public static void ExecuteCommand( string command )
		{
			...
			{
				if (m_commondActions[i](command)) return;
			}
